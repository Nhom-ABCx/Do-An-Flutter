...
class PrdCategory extends StatelessWidget {
  const PrdCategory(this.sanPham,{Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              InkWell(
                onTap: (){},
                child: imageNetwork("${sanPham.hinhAnh!.first.hinhAnh}", width: 130)),
              Expanded(
                  child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("${sanPham.cTSanPham![0].giaBan}", style: const TextStyle(fontWeight: FontWeight.bold)),
