            ...
            Padding(
                ...
                child: Container(
                    decoration: BoxDecoration(
                        ...
                        borderRadius: const BorderRadius.all(Radius.circular(10))),
                    child:
                        Padding(padding: const EdgeInsets.fromLTRB(5, 0, 5, 0), child: _Secsion3)))
          ],
        ),
        ...
        child: Row(
          children: [
            const SizedBox(
              ...
              height: 50,
              child: TextField(
                  decoration: InputDecoration(border: OutlineInputBorder(), hintText: 'SUHA30')),
            ),
            ElevatedButton(
                onPressed: () {},
...
final Widget _Secsion3 = Row(
  ...
  children: [
    ...
    ElevatedButton(
      onPressed: () {},
      child: const Text('Checkout Now', style: TextStyle(color: Colors.black38)),
      style: ElevatedButton.styleFrom(
